...
const returnMovieTitle = (watchlist) => {
	return watchlist
		.map(movie => {if (movie.Director === 'Christopher Nolan' && parseFloat(movie.imdbRating) > 8.0) {return movie.Title;} //mapea los titutlosd de las peliculas que cumplen las funciones 
		else{
			return null //devuelve null para luego poder ser filtrado mas facil
		}
		})
